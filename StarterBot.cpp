...
void StarterBot::checkBuildOrder()
{
    ...
    if (totalSupply == 18 || !m_rushed)
    {
        ...
        else if (unusedSupply == 0 && !m_overlordBuilt)
        {
            m_overlordWanted = 2;
            buildOverlord();
        }
    }
    else if (!m_lairBuilt && m_rushed && totalSupply > 18)
    {
        if (!m_hatcheryBuilt)
        {
            //std::cout << "Test";
        ...
        else if (!m_lairBuilt && m_extractorBuilt)
        {
            m_drones_wanted = 9;
...
void StarterBot::buildOverlord()
{
    ...
    if (ownedOverlords < m_overlordWanted)
    {
...
void StarterBot::buildHydraliskDen()
{
    ...
    if (denOwned < m_hydraDenWanted)
    {
        ...
        const bool startedBuilding = Tools::BuildBuilding(den);
        if (startedBuilding)
        {
