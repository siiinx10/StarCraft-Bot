...
namespace Tools
{
    ...
    int CountUnitsOfType(BWAPI::UnitType type, const BWAPI::Unitset& units, bool complete = false, bool idle =false);
    ...
    const BWEM::ChokePoint* getChokePoint(BWAPI::TilePosition a, BWAPI::TilePosition b);
